...
local function create(bufnr, _1_)
  ...
  return vim.api.nvim_open_win(bufnr, _3_, {width = width, height = height, row = row, col = col, focusable = focusable, noautocmd = true, relative = "editor", anchor = "NW", style = "minimal", border = {"\226\149\173", "\226\148\128", "\226\149\174", "\226\148\130", "\226\149\175", "\226\148\128", "\226\149\176", "\226\148\130"}})
end
_2amodule_2a["create"] = create
local function update(winnr, _5_)
  local _arg_6_ = _5_
  local width = _arg_6_["width"]
  local height = _arg_6_["height"]
  local row = _arg_6_["row"]
  local col = _arg_6_["col"]
  local focusable = _arg_6_["focusable"]
