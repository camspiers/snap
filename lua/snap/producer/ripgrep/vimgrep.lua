...
local _0_0
do
  local name_0_ = "snap.producer.ripgrep.vimgrep"
  local module_0_
  do
...
local _2amodule_name_2a = "snap.producer.ripgrep.vimgrep"
...
do
  ...
  do
    ...
    local function create0(request)
      return general.create({"--vimgrep", "--hidden", request.filter}, request)
    end
    v_0_0 = create0
    _0_0["create"] = v_0_0
    v_0_ = v_0_0
